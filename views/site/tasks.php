...
<h1><a href="section?section_id=<?php echo $section_model->id; ?>"><img src="../../web/images/icons/arrow-left-circle%20(1).svg" class="icon"></a>Задачи раздела "<?php echo $section_model->title; ?>" <a href="../task/create?section_id=<?php echo $section_model->id; ?>"><img src="../../web/images/icons/plus-circle.svg" class="icon-plus"></a></h1>
